/** \file freeMoving3DCameraController.h
*/
#pragma once
...
{
	/**
	\class Free3DCameraController
	\brief Controller 3D free moving camera
	*/
	class Free3DCameraController : public CameraController
	{
	private:
	...
	public:
		...
		*/
		Free3DCameraController(bool update) : m_bUpdate(update) {}
